...
function render(variables = {}) {
  ...
  if (variables.socialMediaPosition == null) variables.socialMediaPosition = "position-left";
  if (variables.twitter == null) variables.twitter = "https://twitter.com/alesanchezr";
  if (variables.github == "alesanchezr") variables.github = "https://github.com/alesanchezr";
  if (variables.instagram == null) variables.instagram = "https://instagram.com/alesanchezr";
  if (variables.linkedin == null) variables.linkedin = "https://linkedin.com/alesanchezr";
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class=${variables.socialMediaPosition}>
            <li><a href="${variables.twitter}"n><i class="fa fa-twitter"></i></a></li>
